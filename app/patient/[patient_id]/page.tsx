...
export default async function DashboardPage({ params }: pageProps) {
  ...
  const recentApps: [any] = appointments.data.map((appointment: any) => {
    return {
      id: appointment.id,
      ...
      doctorLink:
        appointment?.attributes?.doctor?.data?.attributes?.profilepicture?.data
          ?.attributes?.url || doctorDefaultPhoto,
